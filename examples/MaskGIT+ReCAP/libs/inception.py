...
class InceptionV3(nn.Module):
    ...
    def __init__(
        ...
        inception = fid_inception_v3(weight_path) if use_fid_inception else _inception_v3(pretrained=True)
...
def fid_inception_v3(weight_path):
    if weight_path is None:
        raise ValueError("weight_path must be provided for FID Inception.")
    ...
    inception.load_state_dict(torch.load(weight_path, map_location="cpu"))
    return inception
